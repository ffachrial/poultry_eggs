...
export default function Sidebar({ className }: { className?: string }) {
  ...
  return (
    <div className={`flex h-full w-64 flex-col bg-gray-900 text-white ${className || ""}`}>
      ...
      <div className="border-t border-gray-800 p-4">
        ...
        <button
          onClick={() => signOut()}
          className="flex w-full items-center rounded-lg px-3 py-2 text-sm font-medium text-gray-400 hover:bg-red-900/20 hover:text-red-400 transition-colors"
        >
